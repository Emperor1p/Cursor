...
// Calendly Integration - Simplified
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (calendlyBtn) {
        calendlyBtn.addEventListener('click', function() {
            ...
            showNotification('Opening consultation booking...', 'info');
        });
    }

    if (quickCallBtn) {
        quickCallBtn.addEventListener('click', function() {
            console.log('Quick call button clicked');
...
window.addEventListener('scroll', () => {
    ...
    const parallaxElements = document.querySelectorAll('.floating-card, .hero-title, .hero-subtitle');
...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.project-card, .skill-category, .stat, .about-content, .contact-content, .testimonial-card, .blog-card, .timeline-item');
...
const scrollAnimations = document.querySelectorAll('.fade-in-up');
